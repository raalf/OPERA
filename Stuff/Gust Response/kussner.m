...
hold on
load('Kussner_m1_0.25_fixed.mat', 'CL2D', 'valDELTIME', 'valMAXTIME');
plot(valDELTIME.*[0:valMAXTIME-1]./0.5, CL2D, '-b', 'LineWidth', 1.5);

load('Kussner_m3_0.25_fixed.mat', 'CL2D', 'valDELTIME', 'valMAXTIME');
plot(valDELTIME.*[0:valMAXTIME-1]./0.5, CL2D, '-.r', 'LineWidth', 1.5);

load('Kussner_m5_0.25_fixed.mat', 'CL2D', 'valDELTIME', 'valMAXTIME');
