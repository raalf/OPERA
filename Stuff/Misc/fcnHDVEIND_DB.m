...
idx = L1 >= 0 & L2 >= 0;
F111(idx) = log((rho2(idx) + L2(idx) + k)./(rho1(idx) + L1(idx) + k));
...
F111(idx) = log(((rho1(idx) - L1(idx)).*(rho2(idx) + L2(idx)) + k)./(g(idx).^2) + k);
...
% H131(idx) = H131(idx) + eps(1,3,1,h(idx));
% H151(idx) = H151(idx) + eps(1,5,1,h(idx));
...
% H311(idx) = H311(idx) + eps(3,1,1,h(idx));
...
% H133(idx) = H133(idx) + eps(1,3,3,h(idx));
% H153(idx) = H153(idx) + eps(1,5,3,h(idx));
...
% H135(idx) = H135(idx) + eps(1,3,5,h(idx));
% H155(idx) = H155(idx) + eps(1,5,5,h(idx));
...
% H315(idx) = H315(idx) + eps(3,1,5,h(idx));
