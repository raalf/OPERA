...
yl = ylim;
hold on
plot([stop_hertz stop_hertz],ylim,'-r','linewidth',1)
hold off

legend('Experimental Data','Experimental Data (0-4x BR)','Location','NorthEast')
...
WH = [4.5*2 5];
fcnFIG2LATEX(hFig5, 'tmotor_fft_0.pdf', WH)
