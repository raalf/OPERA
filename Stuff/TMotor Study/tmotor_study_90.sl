#!/bin/bash -l
#SBATCH --job-name=TMotorStudy90
#SBATCH --account=def-brami # adjust this to match the accounting group you are using to submit jobs
#SBATCH --time=2-18:00:00         # adjust this to match the walltime of your job
#SBATCH --nodes=1      
#SBATCH --ntasks=1
#SBATCH --cpus-per-task=1      # adjust this if you are using parallel commands
#SBATCH --mem=180000             # adjust this according to your the memory requirement per node you need
...
srun matlab -nodisplay -r "tmotor_study_90"