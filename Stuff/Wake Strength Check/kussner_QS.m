...
load('QS\m2_dt1.mat', 'CL', 'valDELTIME', 'valMAXTIME', 'valSPAN', 'valAREA');
...
load('QS\m5_dt1.mat', 'CL', 'valDELTIME', 'valMAXTIME', 'valSPAN', 'valAREA');
AR = (valSPAN.^2)./valAREA;
CLOG2D = CL.*((AR + 2)/AR);
s_t = [1:valMAXTIME].*valDELTIME.*2;
...
load('QS\m8_dt1.mat', 'CL', 'valDELTIME', 'valMAXTIME', 'valSPAN', 'valAREA');
AR = (valSPAN.^2)./valAREA;
CLOG2D = CL.*((AR + 2)/AR);
s_t = [1:valMAXTIME].*valDELTIME.*2;
...
hold on
load('QS\m2_dt0.1.mat', 'CL', 'valDELTIME', 'valMAXTIME', 'valSPAN', 'valAREA');
AR = (valSPAN.^2)./valAREA;
CLOG2D = CL.*((AR + 2)/AR);
s_t = [1:valMAXTIME].*valDELTIME.*2;
plot(s_t((1/valDELTIME):end) - 2, CLOG2D((1/valDELTIME):end), 'ok');
...
load('QS\m5_dt0.1.mat', 'CL', 'valDELTIME', 'valMAXTIME', 'valSPAN', 'valAREA');
AR = (valSPAN.^2)./valAREA;
CLOG2D = CL.*((AR + 2)/AR);
s_t = [1:valMAXTIME].*valDELTIME.*2;
plot(s_t((1/valDELTIME):end) - 2, CLOG2D((1/valDELTIME):end), 'b^');
...
load('QS\m8_dt0.1.mat', 'CL', 'valDELTIME', 'valMAXTIME', 'valSPAN', 'valAREA');
AR = (valSPAN.^2)./valAREA;
CLOG2D = CL.*((AR + 2)/AR);
s_t = [1:valMAXTIME].*valDELTIME.*2;
plot(s_t((1/valDELTIME):end) - 2, CLOG2D((1/valDELTIME):end), 'rs');
...
sgtitle('Quasi-Steady I Kussner Response')
