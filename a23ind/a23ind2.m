...
function [bloc, cloc] = a23ind2(endpoints, elia, phi, yaw, fpl, k)
...
xia(idx) = xia(idx) + 0.03.*elia(idx);
d(idx) = xia(idx) - yia(idx).*tanfi(idx);
...
ga1(idx) =(a2(idx).*zia(idx).*beta2(idx) + b2(idx).*beta1(idx))./ro(idx);
ga2(idx) =(a2(idx).*zia(idx).*beta1(idx) - b2(idx).*beta2(idx))./ro(idx);
de1(idx) =(b2(idx).*zia(idx).*beta2(idx) + c2(idx).*beta1(idx))./ro(idx);
de2(idx) =(b2(idx).*zia(idx).*beta1(idx) - c2(idx).*beta2(idx))./ro(idx);
...
arg11(idx) = ((ga1(idx).*tj2(idx) + de1(idx) - n22(idx)).^2 + (ga2(idx).*tj2(idx) + de2(idx)).^2).*(tj1(idx).*tj1(idx) + zia(idx).*zia(idx));
arg12(idx) = ((ga1(idx).*tj1(idx) + de1(idx) - n21(idx)).^2 + (ga2(idx).*tj1(idx) + de2(idx)).^2).*(tj2(idx).*tj2(idx) + zia(idx).*zia(idx));

%   if(arg12 > EPS_SMALL)
%   else
arg1(idx) = arg11(idx)./EPS_SMALL;
idx2 = (arg12 > EPS_SMALL) & idx;
arg1(idx2) = arg11(idx2)./arg12(idx2);
    
z1(idx) = ga2(idx).*tj2(idx) + de2(idx);
n1(idx) = ga1(idx).*tj2(idx) + de1(idx) - n22(idx);
z2(idx) = ga2(idx).*tj1(idx) + de2(idx);
n2(idx) = ga1(idx).*tj1(idx) + de1(idx) - n21(idx);
    
b21y1(idx) = -zia(idx).*tanfi(idx).*beta1(idx)./2.0./ro(idx);
b21y2(idx) = -zia(idx).*tanfi(idx).*beta2(idx)./ro(idx);
b22y1(idx) = -d(idx).*beta2(idx)./2.0./ro(idx);
b22y2(idx) = -d(idx).*beta1(idx)./ro(idx);
b21z1(idx) = -d(idx).*beta1(idx)./2.0./ro(idx);
b21z2(idx) = -d(idx).*beta2(idx)./ro(idx);
b22z1(idx) = zia(idx).*tanfi(idx).*beta2(idx)./2.0./ro(idx);
b22z2(idx) = zia(idx).*tanfi(idx).*beta1(idx)./ro(idx);
c21y1(idx) =(d(idx) - yia(idx).*tanfi(idx)).*zia(idx).*beta1(idx)./ro(idx);
c21y2(idx) =(d(idx) - yia(idx).*tanfi(idx)).*zia(idx).*beta2(idx).*2.0./ro(idx);

e(idx) = zia(idx).*zia(idx).*tanfi(idx) + yia(idx).*d(idx);

c22y1(idx) = -e(idx).*beta2(idx)./ro(idx);
c22y2(idx) = -2.0.*e(idx).*beta1(idx)./ro(idx);
c21z1(idx) = -e(idx).*beta1(idx)./ro(idx);
c21z2(idx) = -2.0.*e(idx).*beta2(idx)./ro(idx);
c22z1(idx) = -(d(idx) - yia(idx).*tanfi(idx)).*zia(idx).*beta2(idx)./ro(idx);
c22z2(idx) = -(d(idx) - yia(idx).*tanfi(idx)).*zia(idx).*beta1(idx).*2.0./ro(idx);
...
art2(idx2 & idx3) = pi./2.0.*azia(idx2 & idx3)./zia(idx2 & idx3);
idx4 = idx2 & ~idx3;
...
atj21(idx) = abs(tj2(idx)./tj1(idx));
g24(idx) = abs(log(atj21(idx)));
