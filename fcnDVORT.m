...
dgamma22 = [a1(:,2).*align(:,1,1), a2(:,2).*align(:,1,1), a3(:,2).*align(:,1,1), b1(:,2).*align(:,2,1), b2(:,2).*align(:,2,1), b3(:,2).*align(:,2,1)].*-1;

dgamma13 = [zer, zer, zer, b1(:,1), b2(:,1), b3(:,1)];
dgamma23 = [a1(:,2).*align(:,1,2), a2(:,2).*align(:,1,2), a3(:,2).*align(:,1,2), b1(:,2).*align(:,2,2), b2(:,2).*align(:,2,2), b3(:,2).*align(:,2,2)].*-1;
