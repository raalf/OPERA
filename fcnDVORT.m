...
% dgamma22 = [a1(:,2), a2(:,2), b1(:,2), b2(:,2), c2eta(:,2), zer].*-1;

dgamma12 = [a1(:,1), a2(:,1), zer, zer, -c2eta(:,1), zer];
dgamma22 = [a1(:,2).*matALIGN(idx,2,1), a2(:,2).*matALIGN(idx,2,1), b1(:,2).*matALIGN(idx,1,1), b2(:,2).*matALIGN(idx,1,1), (-c2eta(:,2).*matALIGN(idx,2,1) + c2xi(:,2).*matALIGN(idx,1,1)), zer].*-1;

dgamma13 = [zer, zer, b1(:,1), b2(:,1), c2xi(:,1), zer];
dgamma23 = [a1(:,2).*matALIGN(idx,2,2), a2(:,2).*matALIGN(idx,2,2), b1(:,2).*matALIGN(idx,1,2), b2(:,2).*matALIGN(idx,1,2), (-c2eta(:,2).*matALIGN(idx,2,2) + c2xi(:,2).*matALIGN(idx,1,2)), zer].*-1;
