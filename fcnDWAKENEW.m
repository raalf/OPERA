...
res1 = -sum([a1(:,1), a2(:,1), b1(:,1), b2(:,1), c3(:,1)].*matCOEFF(vecTEDVE,:),2);
...
res2 = -sum([a1(:,1), a2(:,1), b1(:,1), b2(:,1), c3(:,1)].*matCOEFF(vecTEDVE,:),2);
...
res3 = -sum([a1(:,1), a2(:,1), b1(:,1), b2(:,1), c3(:,1)].*matCOEFF(vecTEDVE,:),2);
