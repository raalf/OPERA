function [infl_glob] = fcnHDVEINDGLOB(dvenum, dvetype, fpg, matPLEX, matROTANG, matCONTROL, vecDVESYM, vecBOUNDIND, ztol)

infl_loc = fcnHDVEIND_DB(dvenum, dvetype, fpg, matPLEX, matROTANG, matCONTROL, vecBOUNDIND, ztol);
...
if any(vecDVESYM)
    ...
    infl_sym = fcnHDVEIND_DB(dvenum(idx), dvetype(idx), [fpg(idx,1) -fpg(idx,2) fpg(idx,3)], matPLEX, matROTANG, matCONTROL, vecBOUNDIND, ztol);
