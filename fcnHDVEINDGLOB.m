function [infl_glob] = fcnHDVEINDGLOB(dvenum, dvetype, fpg, matPLEX, matROTANG, matCONTROL, vecDVESYM)
...
if any(vecDVESYM)
    ...
    infl_sym = fcnHDVEIND_DB(dvenum(idx), dvetype(idx), [fpg(idx,1) -fpg(idx,2) fpg(idx,3)], matPLEX, matROTANG, matCONTROL);
