...
K0 = fcnK0(S, T, u, alpha, F_lim, tol);
K0(idx_in_plane,:) = fcnK0ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K1 = fcnK1(S, T, u, alpha, F_lim, tol);
K1(idx_in_plane,:) = fcnK1ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K2 = fcnK2(S, T, u, alpha, F_lim, tol);
K2(idx_in_plane,:) = fcnK2ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K3 = fcnK3(S, T, u, alpha, F_lim, tol);
K3(idx_in_plane,:) = fcnK3ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K4 = fcnK4(S, T, u, alpha, F_lim, tol);
K4(idx_in_plane,:) = fcnK4ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K5 = fcnK5(S, T, u, alpha, F_lim, tol);
K5(idx_in_plane,:) = fcnK5ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K6 = fcnK6(S, T, u, alpha, F_lim, tol);
K6(idx_in_plane,:) = fcnK6ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
K7 = fcnK7(S, T, u, alpha, F_lim, tol);
K7(idx_in_plane,:) = fcnK7ip(S(idx_in_plane,:), T(idx_in_plane,:), u(idx_in_plane,:), alpha(idx_in_plane), F_lim(idx_in_plane,:,:), tol);
...
F(:,13) = sum([-1*(1/3) 1*(1/3)].*((4.*L.*S - L).*K7 + (12.*N.*S - 12.*y_m.*S - 9.*N + 4.*y_m).*K6 + ( - 6.*L.*S.*y_m.^2 - 24.*L.*N.*y_m + 8.*L.*S.*alpha + 6.*L.*y_m.^2 - 11.*L.*alpha + 12.*L.*u).*K5 + ( - 18.*N.*y_m.^2.*S + 24.*N.*alpha.*S + 18.*N.*y_m.^2 - 24.*S.*alpha.*y_m - 4.*y_m.^3 - 19.*N.*alpha + 4.*N.*u + 12.*y_m.*alpha - 12.*u.*y_m).*K4 + ( - 2.*L.*S.*y_m.^4 - 6.*L.*S.*alpha.*y_m.^2 - L.*y_m.^4 - 48.*L.*N.*alpha.*y_m + 4.*L.*S.*alpha.^2 + 24.*L.*alpha.*y_m.^2 - 18.*L.*u.*y_m.^2 - 19.*L.*alpha.^2 + 24.*L.*alpha.*u).*K3 + ( - 6.*N.*y_m.^4.*S - 18.*N.*y_m.^2.*alpha.*S + 3.*N.*y_m.^4 + 12.*N.*alpha.^2.*S + 24.*N.*y_m.^2.*alpha - 6.*N.*y_m.^2.*u - 12.*S.*alpha.^2.*y_m - 8.*alpha.*y_m.^3 - 11.*N.*alpha.^2 + 8.*N.*alpha.*u + 12.*y_m.*alpha.^2 - 24.*alpha.*u.*y_m).*K2 + (3.*L.*alpha.*y_m.^4 - 6.*L.*u.*y_m.^4 - 24.*L.*N.*alpha.^2.*y_m + 18.*L.*alpha.^2.*y_m.^2 - 18.*L.*alpha.*u.*y_m.^2 - 9.*L.*alpha.^3 + 12.*L.*alpha.^2.*u).*K1  + ( - N.*alpha.*y_m.^4 - 2.*N.*u.*y_m.^4 + 6.*N.*alpha.^2.*y_m.^2 - 6.*N.*alpha.*u.*y_m.^2 - 4.*alpha.^2.*y_m.^3 - N.*alpha.^3 + 4.*N.*alpha.^2.*u + 4.*y_m.*alpha.^3 - 12.*alpha.^2.*u.*y_m ).*K0), 2) ...
    + fcnH_7(E, D_TE - y_m, alpha, F_lim(:,:,1), F_lim(:,:,2), tol) - fcnH_7(C, D_LE - y_m, alpha, F_lim(:,:,1), F_lim(:,:,2), tol);
