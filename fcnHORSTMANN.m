function [aloc, bloc, cloc] = fcnHORSTMANN(endpoints, ELIA, phi, yaw, fpl, k)
...
C2Z = G212.*C21Z2 + G221.*C22Z1 + G222.*C22Z2 + G231.*C23Z1 + G232.*C23Z2 + G24.*C24Z + G25.*C25Z + G26.*C26Z + G27.*C27Z;
