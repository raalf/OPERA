function [q_ind] = fcnINDVEL(dvenum, dvetype, fpg, matCOEFF, matPLEX, matROTANG, matCENTER, vecDVESDFLIP, bound_ind, ztol)
...
infl_loc = fcnHDVEIND(dvenum, dvetype, fpg, matPLEX, matROTANG, matCENTER, vecDVESDFLIP, bound_ind, ztol);
