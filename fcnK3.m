function I = fcnK3(S, t, u, alpha, F, tol, idx_A, idx_B, idx_C, idx_D, idx_E, idx_F, idx_G) 
len = size(S,1);
I = nan(len,2);
...
I(idx_G) = fcnK3G(S(idx_G), t(idx_G), u(idx_G), alpha(idx_G), reshape(F(idx_G(:,:,[1,1])),[],1,2), tol); 
