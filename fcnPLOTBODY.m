...
% patch('Faces',matDVE(:,:,1),'Vertices',matVLST,'FaceColor',[255  69   0]./255,'FaceAlpha',1,'LineWidth',2);
patch('Faces',matDVE(:,:,1),'Vertices',matVLST,'FaceColor',[255  69   0]./255,'FaceAlpha',0,'LineWidth',2);
hold on
