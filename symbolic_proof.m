...
%%
syms c1x c1y c1z c2x c2y c2z c3x c3y c3z f g u v gamma
...
Gamma = 0.5*A1*v^2 + A2*v + 0.5*B1*u^2 + B2*u + C2*u*v + C3;
gamma = gradient(Gamma, [u, v, zeta]);
