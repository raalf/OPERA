...
hold on
quiver3(pb(:,1), pb(:,2), pb(:,3), q1(:,1), q1(:,2), q1(:,3), 0, 'm','MaxHeadSize',1)
text(pb(:,1) + 0.5*q1(:,1), pb(:,2) + 0.5*q1(:,2), pb(:,3) + 0.5*q1(:,3), 'q1', 'FontSize',fsiz)

quiver3(pb(:,1), pb(:,2), pb(:,3), q2(:,1), q2(:,2), q2(:,3), 0, 'm','MaxHeadSize',1)
text(pb(:,1) + 0.5*q2(:,1), pb(:,2) + 0.5*q2(:,2), pb(:,3) + 0.5*q2(:,3), 'q2', 'FontSize',fsiz)
...
quiver3(pb(:,1), pb(:,2), pb(:,3), q3(:,1), q3(:,2), q3(:,3), 0, 'm','MaxHeadSize',1)
text(pb(:,1) + 0.5*q3(:,1), pb(:,2) + 0.5*q3(:,2), pb(:,3) + 0.5*q3(:,3), 'q3', 'FontSize',fsiz)
